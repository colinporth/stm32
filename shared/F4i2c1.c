...
bool i2cGetStatus() {
  ...
  while ((!I2C_CheckEvent (I2C1, I2C_EVENT_MASTER_MODE_SELECT)) && i2cCountDown)
    i2cCountDown--;
  ...
  while ((!I2C_CheckEvent (I2C1, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED)) && i2cCountDown)
    i2cCountDown--;

  return (I2C_GetFlagStatus (I2C1, I2C_FLAG_AF) == 0x00) && i2cCountDown;
  }
//}}}
//{{{
