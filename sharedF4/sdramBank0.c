...
#include "delay.h"
//}}}
#define FMC_BANK            FMC_Bank1_SDRAM
#define FMC_COMMAND_TARGET  FMC_Command_Target_bank1
//#define FMC_BANK            FMC_Bank2_SDRAM
//#define FMC_COMMAND_TARGET  FMC_Command_Target_bank2
//#define AUTOREFRESH
...
void sdramInit() {
  ...
  FMC_SDRAMInitStructure.FMC_Bank               = FMC_BANK;
  FMC_SDRAMInitStructure.FMC_ColumnBitsNumber   = FMC_ColumnBits_Number_8b; // Row add 7:0
  ...
  FMC_SDRAMTimingInitTypeDef FMC_SDRAMTimingInitStructure;   // 90 Mhz SD clock = 180Mhz/2 = 11.11ns
  FMC_SDRAMTimingInitStructure.FMC_LoadToActiveDelay    = 2; // TMRD: 2 clocks
  ...
  FMC_SDRAMTimingInitStructure.FMC_RowCycleDelay        = 6; // TRC:  min = 63ns  = 6x11.11ns
  FMC_SDRAMTimingInitStructure.FMC_WriteRecoveryTime    = 2; // TWR:  min = 1+7ns = 1+1x11.11ns
  FMC_SDRAMTimingInitStructure.FMC_RPDelay              = 2; // TRP:         15ns = 2x11.11ns
  FMC_SDRAMTimingInitStructure.FMC_RCDDelay             = 2; // TRCD:        15ns = 2x11.1ns
